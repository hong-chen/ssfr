...
def plot_video_frame_arcsix(statements, test=False):
    ...
    if has_att:
        ...
        ax_nav.text( 9.0, 7.5, 'R:%4.1f$^\\circ$' % ang_rol0, ha='right', va='center', color='red', zorder=2, fontsize=6)
        ...
        if has_att_corr:
            ...
            if ~np.isnan(ang_pit_stage0) and ~np.isnan(ang_rol_stage0):
                ...
                ax_nav.text( 9.0, -8.5, 'R:%4.1f$^\\circ$' % ang_rol_stage0, ha='right', va='center', color='green', zorder=2, fontsize=6)
