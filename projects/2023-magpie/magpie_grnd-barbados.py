"""
Code for processing SPN-S data from Jeff at Navy
...
def main_process_data(date, run=True):
    ...
    ssfr.vis.quicklook_bokeh_spns(_fnames_['%s_spns_v2' % date_s], wvl0=None, tmhr0=None, tmhr_range=[10, 22], wvl_range=[350.0, 900.0], tmhr_step=1, wvl_step=5, description=_mission_.upper(), fname_html='%s-%s_%s_%s_ql.html' % (_mission_.upper(), _spns_.upper(), _platform_.upper(), date_s))
#\----------------------------------------------------------------------------/#
