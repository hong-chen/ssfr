...
#╭────────────────────────────────────────────────────────────────────────────╮#
date = datetime.datetime(2024, 8, 7)
operator = 'Arabella Chamberlain'
mission = 'arcsix'
year = '2024'
platform = 'p3b'
comments = '16th research flight, performed cloud wall'
...
alp_time_offset  = -17.67
hsr1_time_offset = 0.00
ssfr_time_offset = -434.47
ssrr_time_offset = -328.88

# alp_ang_pit_offset = 4.3
# alp_ang_rol_offset = 0.2
alp_ang_pit_offset = 5.9
...
prop_ssfr_rad_cal_zen = {'primary_date': '2025-08-12', 'transfer_date': '2025-08-12', 'secondary_date': '2024-08-05',
...
prop_ssfr_rad_cal_nad = {'primary_date': '2025-02-25', 'transfer_date': '2025-02-25', 'secondary_date': '2024-08-04',
                         'int_time': [(80, 250), (120, 350)],
                         'lamp_adjust': True, 'transfer-based_corr': True, }
