...
operator = 'Arabella Chamberlain, Sebastian Becker'
mission = 'arcsix'
year = '2024'
platform = 'p3b'
comments = '9th research flight'
...
alp_time_offset  = -17.52
hsr1_time_offset = 0.00
ssfr_time_offset = -190.69
ssrr_time_offset = -271.93

# alp_ang_pit_offset = 4.3
# alp_ang_rol_offset = 0.2
alp_ang_pit_offset = 5.2
alp_ang_rol_offset = -1.4
