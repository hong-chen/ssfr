...
#╭────────────────────────────────────────────────────────────────────────────╮#
date = datetime.datetime(2024, 6, 13)
operator = 'Arabella Chamberlain'
mission = 'arcsix'
year = '2024'
platform = 'p3b'
comments = '10th research flight'
...
alp_time_offset  = -17.85
hsr1_time_offset = 0.00
ssfr_time_offset = -196.06
ssrr_time_offset = -273.59

# alp_ang_pit_offset = 4.3
# alp_ang_rol_offset = 0.2
alp_ang_pit_offset = 5.0
...
prop_ssfr_rad_cal_zen = {'primary_date': '2024-03-29', 'transfer_date': '2024-03-29', 'secondary_date': '2024-06-09',
...
prop_ssfr_rad_cal_nad = {'primary_date': '2024-03-29', 'transfer_date': '2024-03-29', 'secondary_date': '2024-06-09',
                         'int_time': [(80, 250), (120, 350)],
                         'lamp_adjust': True, 'transfer-based_corr': True, }
